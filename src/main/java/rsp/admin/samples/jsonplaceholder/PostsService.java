...
public class PostsService implements EntityService<String, Post> {
    ...
    @Override
    public CompletableFuture<Optional<KeyedEntity<String, Post>>> create(Post entity) {
        return null;
    }

    @Override
    public CompletableFuture<Optional<KeyedEntity<String, Post>>> delete(String key) {
        return null;
    }
    ...
    @Override
    public CompletableFuture<Optional<KeyedEntity<String, Post>>> getOne(String key) {
        return null;
    }

    @Override
    public CompletableFuture<Optional<KeyedEntity<String, Post>>> update(KeyedEntity<String, Post> updatedKeyedEntity) {
        return null;
    }
}
